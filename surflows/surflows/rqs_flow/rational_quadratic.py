...
"""
RQS spline that is an identity outside of the spline range
"""
def restricted_rational_quadratic_spline(
    inputs,
    unnormalized_widths,
...
def unconstrained_rational_quadratic_spline(
    ...
    # This also correctly passes nans
...
def rational_quadratic_spline(
    ...
    if inverse:
        bin_idx = torch.searchsorted(cumheights, inputs[..., None]) - 1
    else:
